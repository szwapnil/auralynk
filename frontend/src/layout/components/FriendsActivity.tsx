                        ...
                        >
                            <div className='flex items-start gap-3'>
                                <div className='relative'>
                                    ...
                                    <div 
                                        className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-zinc-900 ${onlineUsers.has(user.clerkId) ? "bg-orange-500" : "bg-zinc-500"}`}    
                                        aria-hidden='true'
                                    />
                                </div>
...
const LoginPrompt = () => (
    <div className='h-full flex flex-col items-center justify-center p-6 text-center space-y-4'>
        <div className='relative'>
            <div
                className='absolute -inset-1 bg-gradient-to-r from-orange-500 to-yellow-300 rounded-full blur-lg
